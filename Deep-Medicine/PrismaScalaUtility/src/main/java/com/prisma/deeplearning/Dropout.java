...
public class Dropout {
    ...
    public int n_out;
    public int n_layers;
    public HiddenLayer1[] hiddenLayers;
    public LogisticRegression1 logisticLayer;
    public Random rng;
    ...
    public Dropout(int N, int n_in, int[] hidden_layer_sizes, int n_out, Random rng, String activation) {
        ...
        this.hiddenLayers = new HiddenLayer1[n_layers];
        ...
        for(int i=0; i<this.n_layers; i++) {
            ...
            this.hiddenLayers[i] = new HiddenLayer1(N, input_size, hidden_layer_sizes[i], null, null, rng, activation);

        }

        // construct logisticLayer
        this.logisticLayer = new LogisticRegression1(N, hidden_layer_sizes[this.n_layers-1], n_out);
