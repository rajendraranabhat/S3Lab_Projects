...
public class MLP {
	...
	public int n_hidden;
	public int n_out;
	public HiddenLayer1 hiddenLayer;
	...
	public MLP(int N, int n_in, int n_hidden, int n_out, Random rng) {
		...
		this.hiddenLayer = new HiddenLayer1(N, n_in, n_hidden, null, null, rng, "tanh");

		// construct logisticLayer
		this.logisticLayer = new LogisticRegression1(N, n_hidden, n_out);
	}
