...
def translate_condition(DX):

    mi = chf = pvd = cvd = ccidem = cpd = rhemz = pud = mliverd = diabnc = diabc = hpplegia = renald = cancer = msliver = mcancer = aids =0
    ...
    conditions = [mi,chf ,pvd, cvd ,ccidem ,cpd ,rhemz, pud, mliverd,diabnc ,diabc ,hpplegia ,renald ,cancer ,msliver ,mcancer ,aids,cci]
    return conditions