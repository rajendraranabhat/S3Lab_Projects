   ...
   //      	$cnt=$row['cnt'];
    ...
    <body>
    	...
    	<div id="envelope" class="container" align="center" >
	        ...
	        <br />
	        <p class ="style12" ><b>On the scale from 0 ("no chance") to 100 ("certainty") what is your estimate of the likelihood for this patient to develop following complications in the first seven days after surgery?</b></p> 
			<br />
	        	...
	        	<table align="center" width="95%">
  				...
  				<?php
  					for ($i=0; $i < $net_decisions ; $i++) {
						...
						switch($i){
							// case 0: 
							// echo "<div id=\"docPredict$i\" align=\"center\" style=\"background-image: linear-gradient(to right, #00FF00 0%,#FFFF00 25%,#FFA500 75%, #FF0000 100%); width:65%\" ></div>";
							// break;
							case 1: 
							echo"<div id=\"docPredict$i\" align=\"center\" style=\"background-image: linear-gradient(to right, #00FF00 0%,#FFFF00 38%, #FF0000 50%); width:65%\" ></div>";
							break;
							case 2: 
							echo"<div id=\"docPredict$i\" align=\"center\" style=\"background-image: linear-gradient(to right, #00FF00 0%,#FFFF00 15%, #FF0000 43%); width:65%\" ></div>";
							break;
							case 3: 
							echo"<div id=\"docPredict$i\" align=\"center\" style=\"background-image: linear-gradient(to right, #00FF00 0%,#FFFF00 10%, #FF0000 45%); width:65%\" ></div>";
							break;
							case 5: 
							echo"<div id=\"docPredict$i\" align=\"center\" style=\"background-image: linear-gradient(to right, #00FF00 0%,#FFFF00 5%, #FF0000 44%); width:65%\" ></div>";
							break;
							default:
							echo"<div id=\"docPredict$i\" align=\"center\" style=\"background-image: linear-gradient(to right, #00FF00 0%,#FFFF00 25%,#FFA500 75%, #FF0000 100%); width:65%\" ></div>";
						}
					    ...
					    echo "<label id=\"docPredictVal$i\" style=\"display:none\">50</label>
