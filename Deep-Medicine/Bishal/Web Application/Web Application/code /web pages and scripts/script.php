<?php
	...
	if(isset($_POST['login'])){
		...
		echo "insert into userInfo values('".$username."','".$array[15]."','".$array[16]."','".$array[17]."','".$array[18]."','".$array[19]."','".$array[20]."',".$array[21]."')";
		mysqli_query($con,"insert into userInfo values('".$username."','".$array[15]."','".$array[16]."','".$array[17]."','".$array[18]."','".$array[19]."','".$array[20]."','".$array[21]."')");
