...
static Connection con=null;
	...
	void create() throws Exception{
		...
		String userInfo="create table userInfo(id varchar(50), password varchar(50), gender varchar(50), age varchar(50), role varchar(50), speciality varchar(50), experience varchar(50), name varchar(50))";
