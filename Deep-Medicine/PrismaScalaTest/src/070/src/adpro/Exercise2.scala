...
object Test extends App {
  println(Exercise85_TestCases.r1)
  println(Exercise85_TestCases.r2)
  println(Exercise85_TestCases.r3)

  println(Exercise88_TestCases.checkRatio(1000))
}
...
object Exercise88_TestCases {
  ...
  val unfair_coin = weighted[Boolean] (Gen.unit (true)->1.0, Gen.unit (false)->2.0)
  ...
  def checkRatio (n :Int) :Double =
    ...
    { case (z,y) => z.length / (z.length.toDouble + y.length) }
